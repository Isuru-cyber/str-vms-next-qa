...
export function AnalyticsDashboard({
  ...
  const demandData = useMemo(() => {
    ...
    const allocatedOrCompleted = initialRequests.filter((r) => ['ALLOCATED', 'COMPLETED'].includes(r.status));
      ...
      {activeTab === 'cost' && (
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-xs border border-slate-200 overflow-hidden">
            ...
            {/* -------------------------------------------------- */}
            {costSubTab === 'trips' && (
              <div className="overflow-x-auto border-t border-slate-200 max-h-[calc(100vh-320px)] min-h-[300px]">
      ...
      {activeTab === 'fleet' && (
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-2xl shadow-xs border border-slate-200 overflow-hidden">
            ...
            <div className="overflow-x-auto max-h-[calc(100vh-320px)] min-h-[260px]">
